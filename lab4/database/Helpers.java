...
public class Helpers {
    ...
    public static void addStudents() {
        ...
        /*System.out.println(Database.getDatabase().findAllStudents());
        System.out.println("inainte -- - -- - - -");
        System.out.println(Database.getDatabase().findAllStudents().get(0));
        Database.getDatabase().findAllStudents().get(0).setFirstName("Malone");
