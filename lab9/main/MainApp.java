...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        StepCountStrategy stepCountStrategy = stepCountStrategyFactory.getStrategy(strategyType, dataRepository.getStoredData());


        // TODO: add observers to the dataRepository
        // don't forget to provide the strategy to the DataAggregator observer
        ConsoleLogger consoleLogger = new ConsoleLogger();
        Aggregator aggregator = new Aggregator(stepCountStrategy);
